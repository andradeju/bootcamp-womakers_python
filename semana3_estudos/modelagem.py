...
#Inicializa o estacionamento e imprime o estado
...
#um carro e uma moto deizam o estacionamento
estacionamento.remover_carro(carros[1])
estacionamento.remover_moto(motos[3])
print(estacionamento)

#chega uma novo moto - deve usar preferencialmente a vaga de moto que foi liberada anteriormente
